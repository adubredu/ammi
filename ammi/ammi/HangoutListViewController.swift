...
class HangoutListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "hangout_cell", for: indexPath) as! HangoutPostTableViewCell
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "showHangoutListInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! HangoutInfoViewController
