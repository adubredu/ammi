...
class MiscListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        })
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "misc_cell", for: indexPath) as! MiscPostTableViewCell
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "showMiscListInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! MiscInfoViewController
