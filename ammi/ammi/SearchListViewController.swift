...
class SearchListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate
{
    ...
    var resultkeywords = [String: [String]]()
...
//        }
    ...
    func collect_keywords()
    {
        for the_posts in posts
        {
            var words = [String]()
            words.append(the_posts.ammi_name)
            
            for i in the_posts.ammi_keywords
            {
                words.append(i)
            }
            ...
            for word in words
            {
                if var pid = keywords[word]
                {
                    pid.append(the_posts.postID)
                    keywords[word] = pid
                }
                ...
                {
                    var ray = [String]()
                    ray.append(the_posts.postID)
                    keywords[word] = ray
                }
            }
        }
        self.resultkeywords = keywords
    }
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "searchListPickedInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! SearchInfoViewController
...
class Downloaded_Posts: NSObject
{
    ...
    var ammi_date: String!
    var ammi_time: String!
