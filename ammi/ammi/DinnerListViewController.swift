...
class DinnerListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "dinner_cell", for: indexPath) as! DinnerPostTableViewCell
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "showDinnerListInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! DinnerInfoViewController
