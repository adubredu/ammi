...
class BreakfastListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "breakfast_cell", for: indexPath) as! BreakfastPostTableViewCell
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "showBreakfastListInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! BreakfastInfoViewController
