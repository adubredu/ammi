...
class ChillListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "chill_cell", for: indexPath) as! ChillPostTableViewCell
    ...
    func tableView(_ tableView: UITableView, didHighlightRowAt indexPath: IndexPath)
    {
        ...
        performSegue(withIdentifier: "showChillListInfo", sender: self)
    ...
    {
        let searchcontroller = segue.destination as! ChillInfoViewController
